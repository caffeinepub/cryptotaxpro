...
export class Backend implements backendInterface {
    ...
    async getHarvestCandidates(): Promise<Array<HarvestCandidate>> {
        if (this.processError) {
            try {
    ...
    async getTaxSummary(arg0: bigint): Promise<TaxSummary> {
        if (this.processError) {
            try {
                const result = await this.actor.getTaxSummary(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async upgradePlan(arg0: string): Promise<void> {
        if (this.processError) {
            try {
